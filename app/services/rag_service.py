...
class RAGService:
    ...
    def process_rag_query(self, query: str, context_limit: int = 5) -> Dict[str, Any]:
        ...
        try:
            ...
            rag_query = RAGQuery(
                query_text=query,
                query_hash=RAGQuery.generate_query_hash(query),
                search_type='similarity',
                max_results=context_limit,
                results_found=len(context_chunks),
                results_used=len(context_chunks),
            ...
            return {
                ...
                'timestamp': rag_query.created_at.isoformat()
            }
    ...
    def get_document_stats(self) -> Dict[str, Any]:
        ...
        try:
            stats = {
                'total_documents': Document.query.filter(Document.status != 'failed').count(),
